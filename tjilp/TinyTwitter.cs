...
namespace TinyTwitter
{
	...
	{
		public static void UpdateStatus(OAuthInfo oauth, string message)
		{
		...
		private class RequestBuilder
		{
			...
			public WebResponse Execute()
			{
                ...
                catch (WebException e)
                {
                    ...
                    {
                        File.Delete(tjilp.MainWindow.FullTokensPath);
                        File.WriteAllText(tjilp.MainWindow.FullTweetDraftPath, tjilp.MainWindow.This.InputBox.Text.Trim());
